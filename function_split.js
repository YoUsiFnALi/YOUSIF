...
var regSpinner = '<i class="fa fa-circle-o-notch fa-spin fa-fw reg_spinner"></i>';
...
callSaved = function(text, type) {
	...
	new jBox("Notice", {
		content: '<p style="direction: rtl;font-weight: bold;"><i class="fa fa-'+i+'"></i> <span>'+text+'</span></p>',
		color: c,
		autoClose: 2500,
		stack: false,
		attributes: {
...
codyEmptyModal = function(r){
	
	$('#notification_menu_content').html(r);
